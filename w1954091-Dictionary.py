...
Dictionary = dict()    #open dictionary
marks = []    #open list
...
while True:
    try:
        ...
        if ID[0] == "w" and ID[1:7].isdigit() and len(ID) == 8:       #conditions for student ID
            ...
            if credit_pass == 120:
                ...
                z = "progress - " + str(credit_pass) + "," + str(credit_defer) + "," + str(credit_fail)
                Dictionary[ID] = z
                ...
                marks.append(credit_defer)      # add to the list
                marks.append(credit_fail)
                z = "progress (module trailer) - " + str(credit_pass) + "," + str(credit_defer) + "," + str(credit_fail)
                Dictionary[ID] = z
            elif credit_fail > 70:
                print("Exclude")
                c += 1
                ...
                marks.append(credit_defer)      # add to the list
                marks.append(credit_fail)
                z = "Exclude - " + str(credit_pass) + "," + str(credit_defer) + "," + str(credit_fail)
                Dictionary[ID] = z
            else:
                ...
                marks.append(credit_defer)    # add to the list
                marks.append(credit_fail)
                z = "Do not progress – module retriever - " + str(credit_pass) + "," + str(credit_defer) + "," + str(credit_fail)
                Dictionary[ID] = z
        else:
            print("Invalid ID")
            continue
